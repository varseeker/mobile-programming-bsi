...
class _PegawaiUpdateFormState extends State<PegawaiUpdateForm> {
  ...
  _fieldTglLhrPegawai() {
    return TextField(
      decoration: InputDecoration(labelText: "Tgl Lahir Pegawai"),
  ...
  _fieldTelpPegawai() {
    return TextField(
      decoration: InputDecoration(labelText: "Telp Pegawai"),
      ...
      onPressed: () async {
        ...
        await PegawaiService().ubah(pegawai, id).then((value) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => PegawaiDetailPage(pegawai: value),
            ),
          );
        });
      },
